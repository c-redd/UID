...
public class Voter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelVOTER1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTextFieldSearch, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabelLastName.setText("Card Number:");
        ...
        jLabelLastName3.setText("Polling Station :");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldCN, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldCID, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldPS, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextFieldDI, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jTableNRC.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Client ID", "Card No.", "D. of Issue", "Polling Station"
            }
        ));
...
//                
                List<Test_Voters> Voters = q.getResultList();
                DefaultTableModel tbModel = (DefaultTableModel)jTableNRC.getModel();

                for ( Test_Voters voter : Voters){
                    String entry_data[] = {voter.getClientID().toString(), voter.getCardNumber().toString(), voter.getIssueDate(), voter.getPollingStation().toString()};
                    tbModel.addRow(entry_data);
    ...
    private void jButtonSAVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSAVEActionPerformed
        // TODO add your handling code here:
        if(jTextFieldCID.getText().equals("")||jTextFieldCN.getText().equals("")||jTextFieldDI.getText().equals("")||jTextFieldPS.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(this, "Please Enter All Data!");
                ...
                voter.setClientID(Long.parseLong(jTextFieldCID.getText()));
                voter.setCardNumber(jTextFieldCN.getText());
                voter.setIssueDate(parseDate(jTextFieldDI.getText()));
                voter.setPollingStation(Long.parseLong(jTextFieldPS.getText()));
    ...
    private void jButtonDELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDELETEActionPerformed
        ...
        if(jTableNRC.getSelectedRow()==-1){
            ...
            EntityManager em = createEntityManager();
            Long voterClientID = Long.parseLong(tbModel.getValueAt(jTableNRC.getSelectedRow(), 0).toString());
            // Example Voter Instannce
            Test_Voters voter = em.find(Test_Voters.class, voterClientID);
    ...
    private void jButtonUPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUPDATEActionPerformed
        ...
        if(jTableNRC.getSelectedRow()==-1){
            ...
            // Get the Voter model from the database
            Test_Voters voter = em.find(Test_Voters.class, voterClientID);
            voter.setCardNumber(jTextFieldCN.getText());
            voter.setIssueDate(parseDate(jTextFieldDI.getText()));
            voter.setPollingStation(Long.parseLong(jTextFieldPS.getText()));
            ...
            // Once Completed Update the jtext field and table
            tbModel.setValueAt(jTextFieldCID.getText(),jTableNRC.getSelectedRow(),0);
            tbModel.setValueAt(jTextFieldCN.getText(),jTableNRC.getSelectedRow(),1);
            
            tbModel.setValueAt(jTextFieldDI.getText(),jTableNRC.getSelectedRow(),2);
            tbModel.setValueAt(jTextFieldPS.getText(),jTableNRC.getSelectedRow(),3);
...
//          clearTextFields();
    ...
    private void jTableNRCMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableNRCMouseClicked
        ...
        jTextFieldCN.setText(tbModel.getValueAt(jTableNRC.getSelectedRow(), 1).toString());
        // Needs to be parsed back to dd-MM-yyyy
        jTextFieldDI.setText(tbModel.getValueAt(jTableNRC.getSelectedRow(), 2).toString());
        jTextFieldPS.setText(tbModel.getValueAt(jTableNRC.getSelectedRow(), 3).toString());
